    ...
    if (_isInit) {
      if (ModalRoute.of(context).settings.arguments != null) {
        ...
        _initValues = {
          ...
          'salePrice': _tempProd.salePrice.toString(),
                ...
                child: Column(
                  children: [
                    ...
                    TextFormField(
                      ...
                      decoration: const InputDecoration(labelText: '商品特價價格'),
                      textInputAction: TextInputAction.next,
                      keyboardType: const TextInputType.numberWithOptions(
                        decimal: true,
                        signed: true,
                    ...
                    TextFormField(
                      ...
                      maxLines: 5,
                      validator: (value) =>
                          value.length < 10 ? '商品描述不得少於十個字' : null,
                      onSaved: (newValue) => _tempProd = Product(
                        id: _tempProd.id,
                        name: _tempProd.name,
                        price: _tempProd.price,
